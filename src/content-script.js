// contentScript.js
// This content script runs on the Spotify authorization page to capture the URL
...
// Send the authorization code to the popup script
const authorizationCode = getQueryParam(window.location.href, "code");
if (authorizationCode) {
  chrome.runtime.sendMessage({ authorizationCode: authorizationCode });
}
